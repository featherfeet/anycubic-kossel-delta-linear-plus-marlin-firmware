 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 8     // Degrees Celsius (was 4 before OLIVER TREVOR modified it)
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS 4 // Degrees Celsius (was 2 before OLIVER TREVOR modified it)

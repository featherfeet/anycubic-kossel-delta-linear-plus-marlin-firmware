...
void lcd_printPGM_utf(const char *str, uint8_t n=LCD_WIDTH) {
  ...
  static void logo_lines(const char* const extra) {
    ...
    lcd.setCursor(indent, 1);  lcd_printPGM(PSTR("Anycubic L+ "));  lcd_printPGM(extra);
    lcd.setCursor(indent, 2);  lcd_printPGM(PSTR("Marlin 1.1.7 "));  lcd_printPGM(extra);
    lcd.setCursor(indent, 3); lcd.write('\x02'); lcd_printPGM(PSTR( " " ));  lcd.write('\x03');
  }
